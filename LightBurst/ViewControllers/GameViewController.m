...
//     --------------------------------------------------
    ...
    {
        self.restartButtonView = [[containerView alloc] initWithLeft:buttonHorizontalPosition1 top:controlPanelTop size:pngButtonSize image:@"restart.png" label:@"restart" andHue: hue];
    ...
    {
        self.solutionButtonView = [[containerView alloc] initWithLeft:buttonHorizontalPosition2 top:controlPanelTop size:pngButtonSize image:@"solution.png" label:@"solution" andHue: hue];
    ...
    {
        self.settingsButtonView = [[containerView alloc] initWithLeft:buttonHorizontalPosition3 top:controlPanelTop size:pngButtonSize image:@"settings.png" label:@"settings" andHue: hue];
    ...
    {
        self.newgameButtonView = [[containerView alloc] initWithLeft:buttonHorizontalPosition4 top:controlPanelTop size:pngButtonSize image:@"newgame.png" label:@"new game" andHue: hue];
